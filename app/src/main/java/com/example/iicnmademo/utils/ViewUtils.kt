package com.example.iicnmademo.utils
...
import com.example.iicnmademo.domain.model.utils.getHumanReadableText
import com.example.iicnmademo.domain.model.utils.toIIError
import com.example.iicnmademo.ui.common.loadstate.ListLoadStateView
    ...
    loadStateFlow.debounce(500).collectLatest { loadState ->
        ...
        if (loadState.refresh is LoadState.Error) {
            ...
            (loadState.mediator?.refresh as? LoadState.Error)?.let {
                context.showToast(context.getString(R.string.api_error_prefix) + it.error.toString())
            }
        } else {
